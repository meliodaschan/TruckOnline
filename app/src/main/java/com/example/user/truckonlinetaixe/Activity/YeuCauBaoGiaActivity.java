...
import com.example.user.truckonlinetaixe.Adapter.YeuCauBaoGiaAdapter;
...
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_DON_HANG_KH;
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_XOA_CHUYEN_XE;
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_CAP_NHAT_DANG_CHO;
...
public class YeuCauBaoGiaActivity extends AppCompatActivity {
    String urlGetData = URL_BASE + API_DON_HANG_KH;
    String urlXoaChuyenXe = URL_BASE + API_XOA_CHUYEN_XE;
    String urlCapNhatTrangThaiChuyenXe = URL_BASE + API_CAP_NHAT_DANG_CHO;
