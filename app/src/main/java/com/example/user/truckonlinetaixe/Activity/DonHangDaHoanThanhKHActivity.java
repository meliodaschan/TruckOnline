...
import com.example.user.truckonlinetaixe.Adapter.DonHangDaHoanThanhAdapter;
...
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_DON_HANG_KH_DA_HOAN_THANH;
...
public class DonHangDaHoanThanhKHActivity extends AppCompatActivity {
    String urlGetData = URL_BASE + API_DON_HANG_KH_DA_HOAN_THANH;
    ...
    DonHangDaHoanThanhAdapter adapter;
...
//        adapter.notifyDataSetChanged();
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DonHangDaHoanThanhKHActivity.this, MapsActivity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlXoaChuyenXe,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(DonHangDaHoanThanhKHActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            GetDataDonHang(urlGetData);
                        } else {
                            Toast.makeText(DonHangDaHoanThanhKHActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DonHangDaHoanThanhKHActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
...
//                        GetTaiXeGanNhat(urlGetDiaDiemTaiXe);
                        Toast.makeText(DonHangDaHoanThanhKHActivity.this, "Thành công !!!", Toast.LENGTH_SHORT).show();
...
//        requestQueue.add(stringRequest);
        ...
        try {
            ...
            Log.d(getTAG(DonHangDaHoanThanhKHActivity.class), request.toString());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        JsonObjectRequest jsArrayRequest = new JsonObjectRequest
                (Request.Method.POST, url, request, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                adapter=new DonHangDaHoanThanhAdapter(DonHangDaHoanThanhKHActivity.this, R.layout.activity_donhang_dahoanthanh,mangCX);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(getApplicationContext(),
                                error.getMessage(), Toast.LENGTH_SHORT).show();
                        Log.d(getTAG(DonHangDaHoanThanhKHActivity.class), error.getLocalizedMessage());
                    }
                });
