...
public class ChiTietDonHangDangChoKHActivity extends AppCompatActivity {
...
//                .init();
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChiTietDonHangDangChoKHActivity.this, DonHangDangChoKHActivity.class);
        ...
        textViewSDT.setText(dh.getSdtTX());
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(ChiTietDonHangDangChoKHActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ChiTietDonHangDangChoKHActivity.this,DonHangDangChoKHActivity.class));
                        } else {

                            Toast.makeText(ChiTietDonHangDangChoKHActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
...
//                        Toast.makeText(ChiTietDonHangDangChoKHActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
    ...
    private void HuyDonHangDangCho(String url)
    {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url,
            ...
            public void onResponse(String response) {
                if (response.trim().equals("success")) {
                    Toast.makeText(ChiTietDonHangDangChoKHActivity.this, "Đã hủy thành công", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(ChiTietDonHangDangChoKHActivity.this,DonHangDangChoKHActivity.class));

                }
                else {
                    Toast.makeText(ChiTietDonHangDangChoKHActivity.this,"Lỗi",Toast.LENGTH_SHORT);
                }
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ChiTietDonHangDangChoKHActivity.this,"Xảy ra lỗi",Toast.LENGTH_SHORT);
