...
import com.example.user.truckonlinetaixe.Activity.ChiTietDonHangDangChoKHActivity;
...
public class DonHangAdapter extends BaseAdapter{
    private DonHangDangChoKHActivity context;
    private int layout;
...
//                XacNhanXemChiTiet(donHang.getID());
                Intent intent =new Intent(context, ChiTietDonHangDangChoKHActivity.class);
    ...
    public DonHangAdapter(DonHangDangChoKHActivity context, int layout, ArrayList<DonHangDangChoKH> donHanglist) {
