...
import com.example.user.truckonlinetaixe.Adapter.DonHangDangChoTXAdapter;
...
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_DON_HANG_TX_DANG_CHO;
import static com.example.user.truckonlinetaixe.Constant.getTAG;


public class DonHangDangChoTXActivity extends AppCompatActivity {
    String urlGetData = URL_BASE + API_DON_HANG_TX_DANG_CHO;
    ...
    DonHangDangChoTXAdapter adapter;
...
//        adapter.notifyDataSetChanged();
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DonHangDangChoTXActivity.this, HomeTXActivity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlXoaChuyenXe,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(DonHangDangChoTXActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            GetDataDonHang(urlGetData);
                        } else {
                            Toast.makeText(DonHangDangChoTXActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DonHangDangChoTXActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
...
//        }
    ...
    public void GetDataDonHang(String url) {
        ...
        try {
            ...
            Log.d(getTAG(DonHangDangChoTXActivity.class), request.toString());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        JsonObjectRequest jsArrayRequest = new JsonObjectRequest
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                adapter= new DonHangDangChoTXAdapter(DonHangDangChoTXActivity.this, R.layout.activity_donhang,mangCX);
