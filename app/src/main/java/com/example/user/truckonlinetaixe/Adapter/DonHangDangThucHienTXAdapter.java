...
import com.example.user.truckonlinetaixe.Activity.ChiTietDonHangDangThucHienTXActivity;
import com.example.user.truckonlinetaixe.Activity.DonHangDangThucHienTXActivity;
import com.example.user.truckonlinetaixe.Model.DonHangDangChoKH;
import com.example.user.truckonlinetaixe.R;

import java.util.ArrayList;

public class DonHangDangThucHienTXAdapter extends BaseAdapter{
    private DonHangDangThucHienTXActivity context;
    private int layout;
...
//                XacNhanXemChiTiet(donHang.getID());
                Intent intent =new Intent(context, ChiTietDonHangDangThucHienTXActivity.class);
...
//    }
    ...
    public DonHangDangThucHienTXAdapter(DonHangDangThucHienTXActivity context, int layout, ArrayList<DonHangDangChoKH> donHanglist) {
