...
import com.example.user.truckonlinetaixe.Activity.ChiTietDonHangDaHuyTXActivity;
import com.example.user.truckonlinetaixe.Activity.DonHangDaHuyTXActivity;
import com.example.user.truckonlinetaixe.Model.DonHangDangChoKH;
import com.example.user.truckonlinetaixe.R;

import java.util.ArrayList;

public class DonHangDaHuyTXAdapter extends BaseAdapter{
    private DonHangDaHuyTXActivity context;
    private int layout;
...
//                XacNhanXemChiTiet(donHang.getID());
                    Intent intent =new Intent(context, ChiTietDonHangDaHuyTXActivity.class);
...
//    }
    ...
    public DonHangDaHuyTXAdapter(DonHangDaHuyTXActivity context, int layout, ArrayList<DonHangDangChoKH> donHanglist) {
