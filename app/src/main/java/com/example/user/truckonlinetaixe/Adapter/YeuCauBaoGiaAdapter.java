...
public class YeuCauBaoGiaAdapter extends BaseAdapter{
    private YeuCauBaoGiaActivity context;
    private int layout;
...
//        holder.textViewTinhTrang1.setText((donHang.getTinhTrang()));
        ...
        holder.btnTuChoi1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                XacNhanXoa(donHang.getID(),donHang.getTokenKH());
            }
        });
    ...
    private void XacNhanXoa(int idchuyenxe, String tokenKH){
        ...
        dialogXoa.setPositiveButton("Có", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                context.XoaDonHang(idchuyenxe);
                context.guiThongBaoChoKhachHang(tokenKH);
                Intent intent =new Intent(context, YeuCauBaoGiaActivity.class);
...
//                context.startActivity(intent);
                ...
                context.CapNhatTrangThai(idchuyenxe);
                Intent intent =new Intent(context, YeuCauBaoGiaActivity.class);
                context.startActivity(intent);
            }
        });
    ...
    public YeuCauBaoGiaAdapter(YeuCauBaoGiaActivity context, int layout, ArrayList<DonHangDangChoKH> donHanglist) {
