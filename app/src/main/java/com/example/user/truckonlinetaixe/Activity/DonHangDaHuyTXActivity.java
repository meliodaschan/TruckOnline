...
import com.example.user.truckonlinetaixe.Adapter.DonHangDaHuyTXAdapter;
...
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_DON_HANG_TX_DA_HUY;
...
public class DonHangDaHuyTXActivity extends AppCompatActivity {
    String urlGetData = URL_BASE + API_DON_HANG_TX_DA_HUY;
