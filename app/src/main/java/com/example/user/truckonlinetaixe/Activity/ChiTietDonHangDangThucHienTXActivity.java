...
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_CAP_NHAT_TAI_KHOAN;
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_DA_NHAN_HANG;
import static com.example.user.truckonlinetaixe.Constant.getTAG;


public class ChiTietDonHangDangThucHienTXActivity extends AppCompatActivity {
    String urlXoaChuyenXe = URL_BASE + API_XOA_CHUYEN_XE;
    String urlCapNhatTaiKhoan = URL_BASE + API_CAP_NHAT_TAI_KHOAN;
    String urlDaNhanHang=URL_BASE+ API_DA_NHAN_HANG;
    ...
    TextView  textViewTenKH,textViewDiemDi,textViewDiemDen,textViewGiaCuoc,
            ...
            textViewLoaiHang,textViewTrongLuongHang,btnDaNhan,btnXoaDangCho;
    ImageView imgBack;
...
//                .init();
        ...
        setContentView(R.layout.activity_chitietdonhang_dangthuchien_tx);
        imgBack = (ImageView) findViewById(R.id.imgBack);
        imgBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChiTietDonHangDangThucHienTXActivity.this, DonHangDangThucHienTXActivity.class);
        ...
        btnDaNhan=(Button)findViewById(R.id.btnDaNhan);
        btnXoaDangCho=(Button)findViewById(R.id.btnXoaDangCho);
        taikhoantru = (Float.valueOf(dh.getTaiKhoan()) - (float)((dh.getGiaCuoc() * 17)/100));
        Log.d("TaiKhoanDaTru",taikhoantru+"");
        Log.d("TaiKhoan",dh.getTaiKhoan()+"");

        idchuyenxedangcho=dh.getID();
        idxexacnhan = dh.getIDXe();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(ChiTietDonHangDangThucHienTXActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ChiTietDonHangDangThucHienTXActivity.this,DonHangDangThucHienTXActivity.class));
                        } else {

                            Toast.makeText(ChiTietDonHangDangThucHienTXActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
...
//                        Toast.makeText(ChiTietDonHangDangChoKHActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
    ...
    private void XacNhanDaNhan(){
        AlertDialog.Builder dialogXoa = new AlertDialog.Builder(context);
        dialogXoa.setMessage("Bạn đã giao nhận thành công ?");
        dialogXoa.setPositiveButton("Có", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                DaNhanHang(urlDaNhanHang);
                CapNhatTaiKhoan(urlCapNhatTaiKhoan);
            }
        });
        dialogXoa.setNegativeButton("Không", new DialogInterface.OnClickListener() {
            @Override
    ...
    private void DaNhanHang(String url)
    {
        RequestQueue requestQueue= Volley.newRequestQueue(this);
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response.trim().equals("success")) {
                    Toast.makeText(ChiTietDonHangDangThucHienTXActivity.this, "Cảm ơn bạn đã sử dụng dịch vụ", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(ChiTietDonHangDangThucHienTXActivity.this,DonHangDangThucHienTXActivity.class));

                }
                else {
                    Toast.makeText(ChiTietDonHangDangThucHienTXActivity.this,"Lỗi",Toast.LENGTH_SHORT);
                }
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ChiTietDonHangDangThucHienTXActivity.this,"Xảy ra lỗi",Toast.LENGTH_SHORT);
    ...
    private void CapNhatTaiKhoan(String url)
    {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(ChiTietDonHangDangThucHienTXActivity.this, "Đã cập nhật thành công", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ChiTietDonHangDangThucHienTXActivity.this, HomeTXActivity.class));
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String,String> params=new HashMap<>();
                params.put("id_xe", String.valueOf(idxexacnhan));
                params.put("taikhoantru", String.valueOf(taikhoantru));
                Log.d("vvvvvvvID",String.valueOf(idxexacnhan)+"");
                Log.d("vvvvvvvTAIKHOAN",String.valueOf(taikhoantru)+"");
