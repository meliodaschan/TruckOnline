...
import com.example.user.truckonlinetaixe.Activity.ChiTietDonHangDaHoanThanhTXActivity;
import com.example.user.truckonlinetaixe.Activity.DonHangDaHoanThanhTXActivity;
import com.example.user.truckonlinetaixe.Model.DonHangDangChoKH;
import com.example.user.truckonlinetaixe.R;

import java.util.ArrayList;

public class DonHangDaHoanThanhTXAdapter extends BaseAdapter{
    private DonHangDaHoanThanhTXActivity context;
    private int layout;
...
//                XacNhanXemChiTiet(donHang.getID());
                    Intent intent =new Intent(context, ChiTietDonHangDaHoanThanhTXActivity.class);
...
//    }
    ...
    public DonHangDaHoanThanhTXAdapter(DonHangDaHoanThanhTXActivity context, int layout, ArrayList<DonHangDangChoKH> donHanglist) {
