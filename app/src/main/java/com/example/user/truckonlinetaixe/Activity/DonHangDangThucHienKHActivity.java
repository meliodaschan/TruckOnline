...
import com.example.user.truckonlinetaixe.Adapter.DonHangDangThucHienAdapter;
...
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_DON_HANG_KH_DANG_THUC_HIEN;
import static com.example.user.truckonlinetaixe.Constant.getTAG;


public class DonHangDangThucHienKHActivity extends AppCompatActivity {
    String urlGetData = URL_BASE + API_DON_HANG_KH_DANG_THUC_HIEN;
    ...
    DonHangDangThucHienAdapter adapter;
...
//        adapter.notifyDataSetChanged();
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DonHangDangThucHienKHActivity.this, MapsActivity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlXoaChuyenXe,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(DonHangDangThucHienKHActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            GetDataDonHang(urlGetData);
                        } else {
                            Toast.makeText(DonHangDangThucHienKHActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DonHangDangThucHienKHActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
...
//                        GetTaiXeGanNhat(urlGetDiaDiemTaiXe);
                        Toast.makeText(DonHangDangThucHienKHActivity.this, "Thành công !!!", Toast.LENGTH_SHORT).show();
...
//                    public void onResponse(String response) {
////                        if(response.trim().equals("success")){
////                            Toast.makeText(DonHangActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
////                            GetData(urlGetData);
////                        }else {
////                            Toast.makeText(DonHangActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
////                        }
//                    }
//                },
//                new Response.ErrorListener() {
//                    @Override
//                    public void onErrorResponse(VolleyError error) {
//                        Toast.makeText(DonHangActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
//                    }
//                }
//        ){
//            @Override
...
//        requestQueue.add(stringRequest);
        ...
        try {
            ...
            Log.d(getTAG(DonHangDangThucHienKHActivity.class), request.toString());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        JsonObjectRequest jsArrayRequest = new JsonObjectRequest
                (Request.Method.POST, url, request, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                adapter=new DonHangDangThucHienAdapter(DonHangDangThucHienKHActivity.this, R.layout.activity_donhang,mangCX);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(getApplicationContext(),
                                error.getMessage(), Toast.LENGTH_SHORT).show();
                        Log.d(getTAG(DonHangDangThucHienKHActivity.class), error.getLocalizedMessage());
                    }
                });
