...
import com.example.user.truckonlinetaixe.Adapter.DonHangDangThucHienTXAdapter;
...
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_DON_HANG_TX_DANG_THUC_HIEN;
import static com.example.user.truckonlinetaixe.Constant.getTAG;


public class DonHangDangThucHienTXActivity extends AppCompatActivity {
    String urlGetData = URL_BASE + API_DON_HANG_TX_DANG_THUC_HIEN;
    ...
    DonHangDangThucHienTXAdapter adapter;
...
//        adapter.notifyDataSetChanged();
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DonHangDangThucHienTXActivity.this, HomeTXActivity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlXoaChuyenXe,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(DonHangDangThucHienTXActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            GetDataDonHang(urlGetData);
                        } else {
                            Toast.makeText(DonHangDangThucHienTXActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DonHangDangThucHienTXActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
...
//                        GetTaiXeGanNhat(urlGetDiaDiemTaiXe);
                        Toast.makeText(DonHangDangThucHienTXActivity.this, "Thành công !!!", Toast.LENGTH_SHORT).show();
    ...
    public void GetDataDonHang(String url) {
        ...
        try {
            ...
            Log.d(getTAG(DonHangDangThucHienTXActivity.class), request.toString());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        JsonObjectRequest jsArrayRequest = new JsonObjectRequest
                (Request.Method.POST, url, request, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                adapter=new DonHangDangThucHienTXAdapter(DonHangDangThucHienTXActivity.this, R.layout.activity_donhang,mangCX);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(getApplicationContext(),
                                error.getMessage(), Toast.LENGTH_SHORT).show();
                        Log.d(getTAG(DonHangDangThucHienTXActivity.class), error.getLocalizedMessage());
                    }
                });
