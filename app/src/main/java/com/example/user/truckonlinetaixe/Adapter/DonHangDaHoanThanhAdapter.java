...
import com.example.user.truckonlinetaixe.Activity.DonHangDaHoanThanhKHActivity;
import com.example.user.truckonlinetaixe.Model.DonHangDangChoKH;
import com.example.user.truckonlinetaixe.R;

import java.util.ArrayList;

public class DonHangDaHoanThanhAdapter extends BaseAdapter{
    private DonHangDaHoanThanhKHActivity context;
    private int layout;
...
//                XacNhanXemChiTiet(donHang.getID());
                    Intent intent =new Intent(context, ChiTietDonHangDaHoanThanhKHActivity.class);
...
//    }
    ...
    public DonHangDaHoanThanhAdapter(DonHangDaHoanThanhKHActivity context, int layout, ArrayList<DonHangDangChoKH> donHanglist) {
