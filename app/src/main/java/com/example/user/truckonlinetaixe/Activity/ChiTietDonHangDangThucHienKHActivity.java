...
public class ChiTietDonHangDangThucHienKHActivity extends AppCompatActivity {
...
//                .init();
        ...
        setContentView(R.layout.activity_chitietdonhang_dangthuchien);
        imgBack = (ImageView) findViewById(R.id.imgBack);
        imgBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChiTietDonHangDangThucHienKHActivity.this, DonHangDangThucHienKHActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(ChiTietDonHangDangThucHienKHActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ChiTietDonHangDangThucHienKHActivity.this,DonHangDangChoKHActivity.class));
                        } else {

                            Toast.makeText(ChiTietDonHangDangThucHienKHActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
...
//                        Toast.makeText(ChiTietDonHangDangChoKHActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
    ...
    private void DaNhanHang(String url)
    {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url,
            ...
            public void onResponse(String response) {
                if (response.trim().equals("success")) {
                    Toast.makeText(ChiTietDonHangDangThucHienKHActivity.this, "Cảm ơn bạn đã sử dụng dịch vụ", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(ChiTietDonHangDangThucHienKHActivity.this,DonHangDangThucHienKHActivity.class));

                }
                else {
                    Toast.makeText(ChiTietDonHangDangThucHienKHActivity.this,"Lỗi",Toast.LENGTH_SHORT);
                }
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ChiTietDonHangDangThucHienKHActivity.this,"Xảy ra lỗi",Toast.LENGTH_SHORT);
