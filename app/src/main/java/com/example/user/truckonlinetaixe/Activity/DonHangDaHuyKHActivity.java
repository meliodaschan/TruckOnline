...
import com.example.user.truckonlinetaixe.Adapter.DonHangDaHuyAdapter;
...
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_DON_HANG_KH_DA_HUY;
...
public class DonHangDaHuyKHActivity extends AppCompatActivity {
    String urlGetData = URL_BASE + API_DON_HANG_KH_DA_HUY;
...
//        adapter.notifyDataSetChanged();
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DonHangDaHuyKHActivity.this, MapsActivity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlXoaChuyenXe,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(DonHangDaHuyKHActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            GetDataDonHang(urlGetData);
                        } else {
                            Toast.makeText(DonHangDaHuyKHActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DonHangDaHuyKHActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
...
//                        GetTaiXeGanNhat(urlGetDiaDiemTaiXe);
                        Toast.makeText(DonHangDaHuyKHActivity.this, "Thành công !!!", Toast.LENGTH_SHORT).show();
...
//        requestQueue.add(stringRequest);
        ...
        try {
            ...
            Log.d(getTAG(DonHangDaHuyKHActivity.class), request.toString());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        JsonObjectRequest jsArrayRequest = new JsonObjectRequest
                (Request.Method.POST, url, request, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                adapter=new DonHangDaHuyAdapter(DonHangDaHuyKHActivity.this, R.layout.activity_donhang_dahuy,mangCX);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(getApplicationContext(),
                                error.getMessage(), Toast.LENGTH_SHORT).show();
                        Log.d(getTAG(DonHangDaHuyKHActivity.class), error.getLocalizedMessage());
                    }
                });
