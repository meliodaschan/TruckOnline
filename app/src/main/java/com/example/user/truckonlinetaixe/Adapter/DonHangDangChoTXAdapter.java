...
import com.example.user.truckonlinetaixe.Activity.ChiTietDonHangDangChoTXActivity;
import com.example.user.truckonlinetaixe.Activity.DonHangDangChoTXActivity;
import com.example.user.truckonlinetaixe.Model.DonHangDangChoKH;
import com.example.user.truckonlinetaixe.R;

import java.util.ArrayList;

public class DonHangDangChoTXAdapter extends BaseAdapter{
    private DonHangDangChoTXActivity context;
    private int layout;
...
//                XacNhanXemChiTiet(donHang.getID());
                Intent intent =new Intent(context, ChiTietDonHangDangChoTXActivity.class);
...
//    }
    ...
    public DonHangDangChoTXAdapter(DonHangDangChoTXActivity context, int layout, ArrayList<DonHangDangChoKH> donHanglist) {
