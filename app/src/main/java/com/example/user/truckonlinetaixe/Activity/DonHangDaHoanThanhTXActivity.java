...
import com.example.user.truckonlinetaixe.Adapter.DonHangDaHoanThanhTXAdapter;
...
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_DON_HANG_TX_DA_HOAN_THANH;
...
public class DonHangDaHoanThanhTXActivity extends AppCompatActivity {
    String urlGetData = URL_BASE + API_DON_HANG_TX_DA_HOAN_THANH;
    ...
    DonHangDaHoanThanhTXAdapter adapter;
...
//        adapter.notifyDataSetChanged();
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DonHangDaHoanThanhTXActivity.this, HomeTXActivity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlXoaChuyenXe,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(DonHangDaHoanThanhTXActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            GetDataDonHang(urlGetData);
                        } else {
                            Toast.makeText(DonHangDaHoanThanhTXActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DonHangDaHoanThanhTXActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
...
//                        GetTaiXeGanNhat(urlGetDiaDiemTaiXe);
                        Toast.makeText(DonHangDaHoanThanhTXActivity.this, "Thành công !!!", Toast.LENGTH_SHORT).show();
    ...
    public void GetDataDonHang(String url) {
        ...
        try {
            ...
            Log.d(getTAG(DonHangDaHoanThanhTXActivity.class), request.toString());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        JsonObjectRequest jsArrayRequest = new JsonObjectRequest
                (Request.Method.POST, url, request, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                adapter=new DonHangDaHoanThanhTXAdapter(DonHangDaHoanThanhTXActivity.this, R.layout.activity_donhang_dahoanthanh,mangCX);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(getApplicationContext(),
                                error.getMessage(), Toast.LENGTH_SHORT).show();
                        Log.d(getTAG(DonHangDaHoanThanhTXActivity.class), error.getLocalizedMessage());
                    }
                });
