...
import static com.example.user.truckonlinetaixe.Connect.APIconnect.API_DA_LAY_HANG;
import static com.example.user.truckonlinetaixe.Constant.getTAG;


public class ChiTietDonHangDangChoTXActivity extends AppCompatActivity {
    ...
    String urlHuyDonHangDangCho=URL_BASE+ API_DA_LAY_HANG;
...
//                .init();
        ...
        setContentView(R.layout.activity_chitietdonhang_dangcho);
        imgBack = (ImageView) findViewById(R.id.imgBack);
        imgBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChiTietDonHangDangChoTXActivity.this, DonHangDangChoTXActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(ChiTietDonHangDangChoTXActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ChiTietDonHangDangChoTXActivity.this,DonHangDangChoTXActivity.class));
                        } else {

                            Toast.makeText(ChiTietDonHangDangChoTXActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
...
//                        Toast.makeText(ChiTietDonHangDangChoKHActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
    ...
    private void XacNhanHuy(){
        AlertDialog.Builder dialogXoa = new AlertDialog.Builder(context);
        dialogXoa.setMessage("Bạn đã lấy hàng thành công ?");
        dialogXoa.setPositiveButton("Đúng", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
    ...
    private void HuyDonHangDangCho(String url)
    {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(ChiTietDonHangDangChoTXActivity.this, "Thông báo đã lấy hàng thành công", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ChiTietDonHangDangChoTXActivity.this,DonHangDangChoTXActivity.class));

                        }
                        else {
                            Toast.makeText(ChiTietDonHangDangChoTXActivity.this,"Lỗi",Toast.LENGTH_SHORT);
                        }
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ChiTietDonHangDangChoTXActivity.this,"Xảy ra lỗi",Toast.LENGTH_SHORT);
