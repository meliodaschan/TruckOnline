...
public class MainActivity extends AppCompatActivity {
    ...
    String urlPostChuyenXe = URL_BASE+"doan/postchuyenxe.php";
    String urlCapNhatTokenTX = URL_BASE+"doan/CapNhatTokenTX.php";
    String urlCapNhatTokenKH = URL_BASE+"doan/CapNhatTokenKH.php";
    @Override
