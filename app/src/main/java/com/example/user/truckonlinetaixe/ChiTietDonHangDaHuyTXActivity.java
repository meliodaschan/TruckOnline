...
public class ChiTietDonHangDaHuyTXActivity extends AppCompatActivity {
...
//                .init();
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChiTietDonHangDaHuyTXActivity.this, DonHangDaHuyTXActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(ChiTietDonHangDaHuyTXActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ChiTietDonHangDaHuyTXActivity.this,DonHangDaHuyTXActivity.class));
                        } else {

                            Toast.makeText(ChiTietDonHangDaHuyTXActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
...
//                        Toast.makeText(ChiTietDonHangDangChoKHActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
    ...
    private void HuyDonHangDangCho(String url)
    {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url,
            ...
            public void onResponse(String response) {
                if (response.trim().equals("success")) {
                    Toast.makeText(ChiTietDonHangDaHuyTXActivity.this, "Đã hủy thành công", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(ChiTietDonHangDaHuyTXActivity.this,DonHangDaHuyTXActivity.class));

                }
                else {
                    Toast.makeText(ChiTietDonHangDaHuyTXActivity.this,"Lỗi",Toast.LENGTH_SHORT);
                }
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ChiTietDonHangDaHuyTXActivity.this,"Xảy ra lỗi",Toast.LENGTH_SHORT);
