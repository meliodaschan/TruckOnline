...
public class ChiTietDonHangDaHuyKHActivity extends AppCompatActivity {
...
//                .init();
        ...
        setContentView(R.layout.activity_chitietdonhang_dahuy);
        imgBack = (ImageView) findViewById(R.id.imgBack);
        imgBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChiTietDonHangDaHuyKHActivity.this, DonHangDaHuyKHActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(ChiTietDonHangDaHuyKHActivity.this, "Xoa thanh cong", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ChiTietDonHangDaHuyKHActivity.this,DonHangDaHuyKHActivity.class));
                        } else {

                            Toast.makeText(ChiTietDonHangDaHuyKHActivity.this, "Loi xoa", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
...
//                        Toast.makeText(ChiTietDonHangDangChoKHActivity.this, "Loi phia api", Toast.LENGTH_SHORT).show();
    ...
    private void HuyDonHangDangCho(String url)
    {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url,
            ...
            public void onResponse(String response) {
                if (response.trim().equals("success")) {
                    Toast.makeText(ChiTietDonHangDaHuyKHActivity.this, "Đã hủy thành công", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(ChiTietDonHangDaHuyKHActivity.this,DonHangDaHuyKHActivity.class));

                }
                else {
                    Toast.makeText(ChiTietDonHangDaHuyKHActivity.this,"Lỗi",Toast.LENGTH_SHORT);
                }
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ChiTietDonHangDaHuyKHActivity.this,"Xảy ra lỗi",Toast.LENGTH_SHORT);
