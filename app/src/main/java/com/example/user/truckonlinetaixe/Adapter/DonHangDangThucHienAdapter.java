...
import com.example.user.truckonlinetaixe.Activity.ChiTietDonHangDangThucHienKHActivity;
import com.example.user.truckonlinetaixe.Activity.DonHangDangThucHienKHActivity;
import com.example.user.truckonlinetaixe.Model.DonHangDangChoKH;
import com.example.user.truckonlinetaixe.R;

import java.util.ArrayList;

public class DonHangDangThucHienAdapter extends BaseAdapter{
    private DonHangDangThucHienKHActivity context;
    private int layout;
...
//        holder.txtGiaCuoc1.setText(donHang.getGiaCuoc()+""+" VNĐ");
        ...
        holder.textViewTinhTrang1.setText("Đang thực hiện");
...
//                XacNhanXemChiTiet(donHang.getID());
                Intent intent =new Intent(context, ChiTietDonHangDangThucHienKHActivity.class);
...
//    }
    ...
    public DonHangDangThucHienAdapter(DonHangDangThucHienKHActivity context, int layout, ArrayList<DonHangDangChoKH> donHanglist) {
